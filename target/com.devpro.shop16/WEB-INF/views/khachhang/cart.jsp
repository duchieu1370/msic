	...
	<main class="container">
		...
		<div class="content">
			...
			<p class="content-title-p1">
				Có <span class="content-title-p2">1 </span>sản phẩm trong giỏ hàng
			</p>
							...
							<tr>
								...
								<td class="border-0">
									<button type="button"
										...
										class="cong"
										style="border: none; background-color: white; font-size: 20px;">+</button>
									<!--  <input type="text" id="textbox" value="1" name="textbox"
									style="width: 5%; text-align: center;" />--> <strong><span
										id="quanlity_${ci.productId }">${ci.quanlity }</span></strong>
									<button type="button" onclick="" class="tru"
								...
								<td class="border-0"><a href="#" class="text-dark"
									onclick="removeSelectedRow();"> <i class="fa fa-trash"></i>
								</a></td>
							</tr>
						</c:forEach>
							...
							<div class="sidebox">
								...
								<ul>
									<li><i class="fas fa-long-arrow-alt-right"></i>Sản phẩm
										được đổi 1 lần duy nhất, không hỗ trợ trả.</li>
									<li><i class="fas fa-long-arrow-alt-right"></i>Sản phẩm
										còn đủ tem mác, chưa qua sử dụng.</li>
									<li><i class="fas fa-long-arrow-alt-right"></i>Sản phẩm
										nguyên giá được đổi trong 30 ngày trên toàn hệ thống.</li>
									<li><i class="fas fa-long-arrow-alt-right"></i>Sản phẩm
