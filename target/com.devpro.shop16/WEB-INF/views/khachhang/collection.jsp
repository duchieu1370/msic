		...
		<div class="content">
			...
			<div class="content-collection">
				<div class="collection-title">
					...
					<div class="card-body" style="display: flex; padding-top:7px; padding-left: 150px;">
						<div style="display: flex; padding-right: 15px">
							<input type="hidden" id="page" name="page" class="form-control">
							<input type="text" id="keyword" name="keyword"
								class="form-control" placeholder="Search"
								value="${searchModel.keyword }"
								style="margin-right: 10px; height: 46px; ">


							<button type="submit" id="btnSearch" name="btnSearch"
								value="Search" class="btn btn-flat btn-outline-secondary mb-3" 
								style="width: 70px; height: 52px; ">Search</button>
						</div>
					</div>
				</div>
