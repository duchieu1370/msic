					...
					<tbody>
						<c:forEach items="${cart.cartItems }" var="ci">
							<tr>
								...
								<td class="border-0"><a type="button"
									href="${base }/cart/view"
									style="list-style-type: none; border: none; background-color: #000; color: white; font-size: 17px;">Update</a>
								</td>
							</tr>
						</c:forEach>
				...
				<div>
					<div class="content-desc">
						...
						<div class="content-desc-p2">
							...
							<div class="p2-total">
								<p>
									Tổng tiền : <span class="total-price"> <fmt:setLocale
											value="vi_VN" /> <fmt:formatNumber
