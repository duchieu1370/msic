				...
				<div class="thongtin">
					...
					<div class="tt-cart">
						<div class="number-product">
							<button type="button" onclick="UpdateQuanlityCart('${base }',${ci.productId })" class="cong">+</button>
					...
					<div class="tt-mota">
						<h3>Mô tả</h3>
						<!--  <p>Sản phẩm được design bởi Mom Says I’m Cool</p>
						<p>Color: đen</p>
						<p>Kích thước:</p>
						<p>Size M: Dài:68cm Rộng: 54cm ( 40kg-57kg)</p>
						<p>Size L: Dài: 70cm Rộng: 56cm ( 58kg-70kg)</p>
						<p>Size XL: Dài 72cm Rộng: 58cm ( 71kg-85kg)</p>
						<p>Vải cotton co dãn 4 chiều dày và mịn, chất đẹp mặc thoáng
							mát</p>-->
						<p>${product.details}</p>
					</div>
				</div>
